<template>
  <div class="template">
    <header>
      ...
      <p>3000</p>
      <p>今日总效果预估（元）</p>
      <p>今日订单数 <span>60</span> 笔</p>
    </header>
    <div class="nav">
      <div class="nav_left">
        <span>上月总可结算收入(元)</span><span>60000</span>
      </div>
      <div class="nav_left nav_right">
        <span>上月总效果预估(元)</span><span>60000</span>
      </div>
    </div>
    <div class="message">
...
<style scope>
  ...
  header {
    width: 100%;
    height: 4.3rem;
    background-image: radial-gradient(50% 93%, #2E6CCE 0%, #3D8CEE 93%);
    padding-top: 0.5rem;
  }
  header p {
    color: #FFFFFF;
  ...
  .nav_right span:nth-child(1) {
    width: 1.5rem;
    text-align: right;
  }
  .nav_left span:nth-child(2) {
    font-size: 0.48rem;
    color: #3C82DC;
    float: left;
  }
  ...
  .message .message_left {
    width: 3.32rem;
    height: 1.74rem;
    background-image: linear-gradient(-46deg, #C1B581 0%, #F6EA96 100%);
    box-shadow: 0 0 6px 0 rgba(202, 202, 202, 0.52);
    float: left;
    margin-right: 0.3rem;
    border-radius: 4px;
  }
  .message .message_left p:nth-child(1) {
    font-size: 0.22rem;
    color: #FFFFFF;
    text-align: left;
    margin-top: 0.1rem;
  ...
  .message .message_left p:nth-child(2) {
    font-size: 0.6rem;
    color: #FFFFFF;
  }
  .message .message_left p:nth-child(3) {
    font-size: 0.22rem;
    color: #FFFFFF;
    text-align: right;
  }
  ...
  .message .message_right p:nth-child(1),
  .message .message_right p:nth-child(2),
  .message .message_right p:nth-child(3) {
    color: #404040;
  }
  .data {
    width: 100%;
  ...
  .buy .data_ul li {
    background-image: linear-gradient(-135deg, #B2B2B2 6%, #D2D1D1 100%);
  }
  .buy .data_ul li p:nth-child(1) {
    font-size: 0.36rem;
  }
  .buy .data_ul li p:nth-child(1) span {
    font-size: 0.6rem;
  }
  .buy .data_ul li p:nth-child(1) {
    color: #ffffff;
  }
  .buy .data_ul li p:nth-child(2) {
    color: #ffffff;
  }
</style>